  ...
  return declare(null, {
    ...
    listen: function () {
      ...
      var showUserProfile = function (evt) {
        ...
        var dlg = new Dialog({
          title: 'User Profile',
          content: "<div class=\"UserProfileForm\" data-dojo-id=\"userProfile\" data-dojo-type=\"p3/widget/UserProfileForm\" style=\"width:430px; margin-left:auto;margin-right:auto;font-size:1.1em;margin-bottom:10px;margin-top:10px;padding:10px;overflow-y:auto;\" data-dojo-props='callbackURL: \"<%- callbackURL %>\"'></div>",
          onHide: function(){
